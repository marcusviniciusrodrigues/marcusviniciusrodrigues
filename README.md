...
Doutorando em Bioinformática pela Universidade Tecnológica Federal do Paraná/Universidade Federal do Paraná - PPGAB (UTFPR-UFPR). Mestre em Bioinformática pela Universidade Tecnológica Federal do Paraná (UTFPR). Possui Licenciatura e Bacharelado em Ciências Biológicas pela Universidade Estadual do Norte do Paraná (UENP). Atuo na área de bioinformática, com ênfase na montagem, análise e extração de características genômicas voltadas para aplicações em pesquisa e desenvolvimento em biotecnologia.
